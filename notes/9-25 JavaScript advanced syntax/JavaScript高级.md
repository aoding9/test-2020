...
- 子类使用super关键字访问父类的方法
  ...
  **注意:** 
  ...
  5. 在 ES6 中类没有变量提升，所以必须先定义类，才能通过类实例化对象![](images1/img2.png)
...
![](images2/img8.png)如果未设置constructor属性,如图:
