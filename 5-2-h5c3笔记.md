...
- 只要左右是auto就可以水平居中
*！对行内（块）元素无效，需要给父级加`text-align:center`*
...
### translate
- 语法：translateX(n) translateY(n) 空格隔开，可合写，也可分开写
...
### 三维空间搭建要点
- 摄像机是观察三维空间的视点位置，用摄像机属性`perspective`和`perspective-origin`可以简单控制观察位置，前者控制远近，后者控制视线平面
...
- .box-3d添加透视，.3d添加3d呈现，让子盒子进入同一个3d空间，.a提高层级，.b翻转180度，让a和b背靠背，最后给.box加过渡效果，并且hover翻转180度
