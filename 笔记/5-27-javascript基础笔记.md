...
- 实际上计算机最终所执行的都是 机器语言，它是由“0”和“1”组成的二进制数，二进制是计算机语言的基础。
  ...
  ![](images/5-27 javascript基础/day1/图片1.png)
...
![](images/5-27 javascript基础/day1/图片4.png)

![](images/5-27 javascript基础/day1/图片5.png)
...
![](images/5-27 javascript基础/day1/图片6.png)
...
![](images/5-27 javascript基础/day1/图片7.png)
...
- 现在也可以基于 Node.js 技术进行服务器端编程
  ...
  ![](images/5-27 javascript基础/day1/图片8.png)
...
![](images/5-27 javascript基础/day1/图片9.png)

### 3.4 浏览器执行 JS 简介

**浏览器分成两部分：渲染引擎和 JS 引擎**

![](images/5-27 javascript基础/day1/neihe.png)



		浏览器本身并不会执行JS代码，而是通过内置 JavaScript 引擎(解释器) 来执行 JS 代码 。JS 引擎执行代码时逐行解释每一句源码（转换为机器语言），然后由计算机去执行，所以 JavaScript 语言归为脚本语言，会逐行解释执行。

![](images/5-27 javascript基础/day1/图片10.png)

### 3.5 JS 的组成

![](images/5-27 javascript基础/day1/图片11.png)
...
1. #### **ECMAScript**
   ...
   ![](images/5-27 javascript基础/day1/图片12.png)
...
![](images/5-27 javascript基础/day1/图片13.png)

### 6.2 变量在内存中的存储

		本质：变量是程序在内存中申请的一块用来存放数据的空间。类似我们酒店的房间，一个房间就可以看做是一个变量。  

![](images/5-27 javascript基础/day1/图片14.png)
...
- 遵守驼峰命名法。首字母小写，后面单词的首字母需要大写。myFirstName![](images/5-27 javascript基础/day1/图片15.png)
...
![](images/5-27 javascript基础/day1/图片16.png)
...
3. 数字型三个特殊值
  ...
  4. isNaN
   ...
   ![](images/5-27 javascript基础/day1/图片17.png)
...
- 获取检测变量的数据类型
  ...
  ![](images/5-27 javascript基础/day1/图片18.png)
...
- 转换为字符串
  ...
  ![](images/5-27 javascript基础/day1/图片19.png)
...
- 转换为数字型（重点）
  ...
  ![](images/5-27 javascript基础/day1/图片20.png)
...
- 转换为布尔型
  ...
  ![](images/5-27 javascript基础/day1/图片21.png)
...
![](images/5-27 javascript基础/day1/图片22.png)
...
![](images/5-27 javascript基础/day1/图片23.png)
...
- 算术运算符概述
  ...
  ![](images/5-27 javascript基础/day2/图片1.png)
...
- 比较运算符概述
  ...
  ![](images/5-27 javascript基础/day2/图片2.png)

- 等号比较

  ![](images/5-27 javascript基础/day2/图片3.png)
...
- 逻辑运算符概述
  ...
  ![](images/5-27 javascript基础/day2/图片4.png)
...
- 逻辑与&&
  ...
  ​                <img src="images/5-27 javascript基础/day2/图片5.png" alt="">

  ​                <img src="images/5-27 javascript基础/day2/图片6.png" alt="">
...
- 逻辑或 ||
  ...
  ​                <img src="images/5-27 javascript基础/day2/图片7.png" alt="">

  ​                <img src="images/5-27 javascript基础/day2/图片8.png" alt="">
...
![](images/5-27 javascript基础/day2/图片9.png)
...
![](images/5-27 javascript基础/day2/图片10.png)
...
![](images/5-27 javascript基础/day2/图片11.png)
...
​                <img src="images/5-27 javascript基础/day2/图片12.png" alt="">
...
- 分支结构
  ...
  由上到下执行代码的过程中，根据不同的条件，执行不同的路径代码（执行代码多选一的过程），从而得到不同的结果
                  <img src="images/5-27 javascript基础/day2/图片13.png" alt="">
...
- if 语句
  ...
  - 执行流程
    ...
    ![](images/5-27 javascript基础/day2/图片14.png)
...
- if else语句（双分支语句）
  ...
  - 执行流程
    ...
    ![](images/5-27 javascript基础/day2/图片15.png)
...
- if else if 语句(多分支语句)
  ...
  - 执行逻辑
    ...
    ![](images/5-27 javascript基础/day2/图片16.png)
...
![](images/5-27 javascript基础/day3/图片1.png)
  ...
  ![](images/5-27 javascript基础/day3/图片2.png)
...
![](images/5-27 javascript基础/day3/图片3.png)
...
![](images/5-27 javascript基础/day4/图片1.png)
...
- 简单理解：封装类似于将电脑配件整合组装到机箱中 ( 类似快递打包）  
  ...
  ![](images/5-27 javascript基础/day4/图片2.png)
...
- 实参：函数调用时传入小括号内的真实数据
  ...
  ![](images/5-27 javascript基础/day4/图片3.png)
...
![](images/5-27 javascript基础/day4/图片4.png)
...
![](images/5-27 javascript基础/day5/图片1.png)
...
![](images/5-27 javascript基础/day5/图片2.png)
...
- 什么是对象？
  ...
  - 方法：事物的行为，在对象中用方法来表示（常用动词）
    ...
    ![](images/5-27 javascript基础/day5/图片3.png)
...
- 使用Date实例的方法和属性	
  ...
  ![](images/5-27 javascript基础/day6/图片1.png)
...
- 数组中有进行增加、删除元素的方法，部分方法如下表
  ...
  ![](images/5-27 javascript基础/day6/图片2.png)
...
- 数组中有对数组本身排序的方法，部分方法如下表
  ...
  ![](images/5-27 javascript基础/day6/图片3.png)
...
- 数组中有获取数组指定元素索引值的方法，部分方法如下表
  ...
  ![](images/5-27 javascript基础/day6/图片4.png)

#### 数组转换为字符串

- 数组中有把数组转化为字符串的方法，部分方法如下表

  ![](images/5-27 javascript基础/day6/图片5.png)
...
- 数组中还有其他操作方法，同学们可以在课下自行查阅学习
  ...
  ![](images/5-27 javascript基础/day6/图片6.png)
...
![](images/5-27 javascript基础/day6/图片7.png)
...
![](images/5-27 javascript基础/day6/图片8.png)

​		在上述方法中，charCodeAt方法返回的是指定位置上字符对应的ASCII码，ASCII码对照表如下：

![](images/5-27 javascript基础/day6/图片9.png)
...
![](images/5-27 javascript基础/day6/图片10.png)
...
![](images/5-27 javascript基础/day6/图片11.png)

- 简单数据类型的存储方式

  ​		值类型变量的数据直接存放在变量（栈空间）中

![](images/5-27 javascript基础/day6/图片12.png)

- 复杂数据类型的存储方式

  ​		引用类型变量（栈空间）里存放的是地址，真正的对象实例存放在堆空间中

  ![](images/5-27 javascript基础/day6/图片13.png)
...
![](images/5-27 javascript基础/day6/图片14.png)
...
![](images/5-27 javascript基础/day6/图片15.png)
